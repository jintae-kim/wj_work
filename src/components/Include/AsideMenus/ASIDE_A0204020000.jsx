...
export const ASIDE_A0204020000 = () => {

  const searchStyleNo = ['All', 'EX']
  const radioLayout = ['Shrink', 'Strength']
  const radioPhantom = ['Normal', 'Max Line']
  const searchConfirm = ['All', 'Y', 'N']
      ...
      <div className="aside-scroll">
        ...
        <div className="search-cate">
          ...
          <div className="sc-box">
            ...
            <div className="sc-cont">
              <RadioGroup className="radio-group" items={radioLayout} defaultValue={radioLayout[0]} />
            </div>
          </div>
          ...
          <div className="sc-box">
            ...
            <div className="sc-cont">
              <RadioGroup className="radio-group" items={radioPhantom} defaultValue={radioPhantom[0]} />
            </div>
          </div>
